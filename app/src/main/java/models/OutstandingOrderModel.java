...
public class OutstandingOrderModel {
    ...
    @Expose
    private ArrayList<OrderDetailsData> orderDetailsData = null;
    ...
    public ArrayList<OrderDetailsData> getOrderDetailsData() {
        return orderDetailsData;
    }

    public void setOrderDetailsData(ArrayList<OrderDetailsData> orderDetailsData) {
